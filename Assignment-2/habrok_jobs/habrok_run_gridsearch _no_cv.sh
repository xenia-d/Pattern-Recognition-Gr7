...
#SBATCH --time=6:00:00               # Time limit for the job (e.g., 2 hours)
...
# Run training
python3 Genes_run_gridsearch.py --cv No_cv

############ SAVING:

# Save models by compressing and copying from TMPDIR
tar czvf /scratch/$USER/pattern-rec/results/No_cv_gridsearch_results.tar.gz $TMPDIR/Assignment-2/gridsearch_results
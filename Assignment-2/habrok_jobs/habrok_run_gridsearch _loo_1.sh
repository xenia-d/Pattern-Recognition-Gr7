#!/bin/bash
#SBATCH --job-name=gridsearch_loo_1         # Job name
...
# Run training
python3 Genes_run_gridsearch.py --cv LeaveOneOut --loo_set 1

############ SAVING:

# Save models by compressing and copying from TMPDIR
tar czvf /scratch/$USER/pattern-rec/results/LeaveOneOut_1_gridsearch_results.tar.gz $TMPDIR/Assignment-2/gridsearch_results